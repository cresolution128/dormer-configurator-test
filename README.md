3D Dormer Configurator

A Three.js-based configurator for positioning and configuring a dormer on a roof.
...
1. Run the application:
   ...
   Or use any static file server to serve the files.
